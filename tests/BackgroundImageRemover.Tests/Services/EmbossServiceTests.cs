...
public class EmbossServiceTests : ServiceTestBase
{
    [Fact]
    public void Apply_PreservesSizeAndType()
    {
        using var input = CreateTestInput(8, 10, new Scalar(40, 90, 140));
    ...
    public void Apply_DifferentAngles_ChangeResult()
    {
        ...
        AssertChangesPixels(east, north);
    }
    ...
    public void Apply_GrayscaleVersusColor_ChangeResult()
    {
        ...
        AssertChangesPixels(gray, color);
    }
